        ...
        <div class="content">
            <form action="#" id="detallesReserva" class="detalles" method="POST">
                ...
                <div class="input-container">
                    ...
                    <input id="tel" type="text" name="tel" placeholder="Tel&eacute;fono" required>
                </div>
                <div class="input-container">
                    <label for="residencia">Residencia</label>
                    <input id="residencia" type="text" name="residencia" placeholder="Residencia" required>
                </div>
                <div class="input-container">
                    <label for="email">Email</label>
                    <input id="email" type="email" name="email" placeholder="email@utec.edu.sv" required>
                </div>
                <div class="input-container">
                ...
                <div class="input-container">
                    ...
                    <input id="confirmPass" type="password" name="confirmPass" placeholder="confirmar" required>
                </div>
